            ...
            <el-table :data="forumData" height="250">
                ...
                <el-table-column label="身份">
                    <template slot-scope="scope">
                        ...
                        <span v-if="scope.row.feizhiyuanId">
                            非志愿者
                        </span>
                ...
                <el-table-column property="caozuo" label="操作">
                    <template slot-scope="scope">
                        <el-button type="info"                          @click="seeForumContent(scope.row.forumContent)">回帖详情</el-button>
                            <el-button v-if="true &&( false|| (sessionTable == 'zhiyuanzhe' && scope.row.zhiyuanzheId ==userId)
|| (sessionTable == 'feizhiyuan' && scope.row.feizhiyuanId ==userId)
                ...
                <el-row class="ad" :style="{justifyContent:contents.btnAdAllBoxPosition=='1'?'flex-start':contents.btnAdAllBoxPosition=='2'?'center':'flex-end'}">
                    <el-form-item>
                        ...
                        <a style="text-decoration:none" class="el-button el-button--success"
                           ...
                           href="http://localhost:8080/xiaoyaunzhiyuanzheguanlixitong/upload/forumMuBan.xls"
                        >批量导入论坛数据模板</a>
                        &nbsp;
                        <el-upload
                                v-if="isAuth('forum','导入导出')"
                ...
                _this.$http({
                    ...
                    if (data && data.code === 0) {
                        ...
                        data.data.list.forEach(el=>{
                            ...
                            forum.feizhiyuanId = el.feizhiyuanId;//---
                            forum.feizhiyuanName = el.feizhiyuanName;
                            forum.feizhiyuanPhone = el.feizhiyuanPhone;
                            forum.feizhiyuanIdNumber = el.feizhiyuanIdNumber;
                            forum.feizhiyuanPhoto = el.feizhiyuanPhoto;
                            forum.feizhiyuanEmail = el.feizhiyuanEmail;
                            forum.createTime = el.createTime;
